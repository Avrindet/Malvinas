 ...
 * Joystick izquierdo: mover | Toque en pantalla: apuntar y disparar
 */
export class TouchControls {
    ...
    this.root.innerHTML = `
      ...
      <div id="touch-actions">
        <div class="touch-actions-row">
          <button type="button" class="touch-btn" data-key="KeyE" data-tap="1">
            <span class="touch-btn-key">E</span><span class="touch-btn-lbl">Rescatar</span>
          </button>
          <button type="button" class="touch-btn" data-key="KeyR" data-tap="1">
            <span class="touch-btn-key">R</span><span class="touch-btn-lbl">Recarga</span>
          </button>
          <button type="button" class="touch-btn" data-key="KeyG" data-tap="1">
            <span class="touch-btn-key">G</span><span class="touch-btn-lbl">Granada</span>
          </button>
          <button type="button" class="touch-btn touch-btn-mortar" data-key="KeyM" data-tap="1">
            <span class="touch-btn-key">M</span><span class="touch-btn-lbl">Mortero</span>
          </button>
          <button type="button" class="touch-btn" data-key="KeyF">
            <span class="touch-btn-key">F</span><span class="touch-btn-lbl">Trinchera</span>
          </button>
        </div>
        <div class="touch-actions-row touch-actions-row-secondary">
          <button type="button" class="touch-btn touch-btn-weapon" data-key="Digit1" data-tap="1">
            <span class="touch-btn-key">1</span>
          </button>
          <button type="button" class="touch-btn touch-btn-weapon" data-key="Digit2" data-tap="1">
            <span class="touch-btn-key">2</span>
          </button>
          <button type="button" class="touch-btn touch-btn-weapon" data-key="Digit3" data-tap="1">
            <span class="touch-btn-key">3</span>
          </button>
          <button type="button" class="touch-btn touch-btn-weapon" data-key="Digit4" data-tap="1">
            <span class="touch-btn-key">4</span>
          </button>
          <button type="button" class="touch-btn" data-key="KeyB" data-tap="1">
            <span class="touch-btn-key">B</span><span class="touch-btn-lbl">Balas</span>
          </button>
          <button type="button" class="touch-btn" data-key="Escape" data-tap="1">
            <span class="touch-btn-key">⏸</span><span class="touch-btn-lbl">Pausa</span>
          </button>
        </div>
      </div>
    `;
  ...
  onFireStart(e) {
    ...
    for (const t of e.changedTouches) {
      ...
      if (this.isTouchInActionsZone(t)) continue;
